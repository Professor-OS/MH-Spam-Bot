...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await idk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await idk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await idk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ydk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ydk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ydk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await wdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await wdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await wdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await hdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await hdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await sdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await sdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await sdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await adk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await adk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await adk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await bdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await bdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await bdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await cdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await cdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await cdk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ddk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ddk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ddk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await edk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await edk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await edk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await vkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await vkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await vkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await kkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await kkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await kkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await lkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await lkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await lkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await mkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await mkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await mkk(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await sid(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await sid(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await sid(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await shy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await shy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await shy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await aan(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await aan(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await aan(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ake(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ake(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await ake(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await eel(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await eel(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await eel(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await khu(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await khu(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await khu(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await shi(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await shi(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await shi(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await yaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await yaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await yaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await dav(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await dav(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await dav(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await raj(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await raj(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await raj(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await put(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await put(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await put(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await eag(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await eag(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await eag(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await gle(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await gle(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await gle(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await gle(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if teight:
        ...
        try:
            ...
            await wal(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await wal(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await wal(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await wal(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await aaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await aaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await aaa(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await boy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await boy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await boy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
            await boy(functions.channels.JoinChannelRequest(channel="@AGORA_SPAM_OFFICIAL"))
...
async def _(e):
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗣𝗿𝗶𝘃𝗮𝘁𝗲 𝗝𝗼𝗶𝗻\n\nCommand:\n\n.pjoin <Private Channel or Group's access hash>\n\nExample :\nLink = https://t.me/Agora_.@agora_professor"
    if e.sender_id in SMEX_USERS:
        yukki = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) > 7:
            bc = yukki[0]
